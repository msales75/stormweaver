...
class Block_Frame_Reflower extends Frame_Reflower {
  ...
  protected function _calculate_restricted_height() {
    ...
    print "Before removing margins, height = $height\n";
    // Remove margin, padding & borders
      // this doesn't make sense -- you don't want to subtract margins from height, do you?
    $height -= $style->length_in_pt( array(
                                           $style->padding_top,
    ...
    print "Containing-block height = ".$cb["h"]."\n";
    print "After removing margins, height = $height\n";
  ...
  function reflow() {
    ...
    print "Defined height = $style->height in reflow for block ".$this->_frame->get_node()->nodeName."\n";
